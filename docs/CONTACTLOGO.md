...
Crest). Those names are retired. GitHub is `jaywedgeworth22/ContactLogo`
(the old `jaywedgeworth22/BadgeBook` slug redirects). Local checkout:
`~/Code/ContactLogo`.
